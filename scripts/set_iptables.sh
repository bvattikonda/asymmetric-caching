...
if [ $1 == "bs" ]; then
    sudo iptables -A OUTPUT -p tcp -s 10.10.10.2 -d 10.10.10.1 -j NFQUEUE --queue-num 1
#    sudo iptables -A FORWARD -p tcp -d 10.10.10.1 -j NFQUEUE --queue-num 1
elif [ $1 == "m" ]; then
    sudo iptables -A INPUT -p 201 -s 10.10.10.2 -d 10.10.10.1 -j NFQUEUE --queue-num 1
elif [ $1 == "c" ]; then
    sudo iptables -F
elif [ $1 == "lo" ]; then
